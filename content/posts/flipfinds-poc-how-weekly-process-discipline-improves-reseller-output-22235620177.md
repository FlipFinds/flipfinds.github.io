...
sourceOfTruthVersion = "1.0.0"
+++

This article is generated from approved FlipFinds source-of-truth data.

## What FlipFinds Does
FlipFinds helps resellers run sourcing and listing workflows with more consistency and less wasted effort.

FlipFinds is currently focused on iOS and Android workflows, with emphasis on:
1. Structured sourcing workflows
2. Listing productivity support
3. Weekly KPI-oriented review habits
...
Hero image: REPLACE_WITH_LANDING_PAGE_HERO_IMAGE_URL
App store screenshot: REPLACE_WITH_APP_STORE_SCREENSHOT_URL
